...
using AutoMapper;
using NewBalance.Application.Exceptions;
...
using NewBalance.Infrastructure.Specifications;
using NewBalance.Shared.Constants.Role;
...
namespace NewBalance.Infrastructure.Services.Identity
{
