...
using NewBalance.Application.Features.ExtendedAttributes.Commands.Delete;
using NewBalance.Application.Features.ExtendedAttributes.Queries.Export;
...
namespace NewBalance.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
