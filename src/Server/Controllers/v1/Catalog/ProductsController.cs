...
using NewBalance.Application.Features.Products.Commands.Delete;
using NewBalance.Application.Features.Products.Queries.Export;
using NewBalance.Application.Features.Products.Queries.GetAllPaged;
using NewBalance.Application.Features.Products.Queries.GetProductImage;
using NewBalance.Shared.Constants.Permission;
using Microsoft.AspNetCore.Authorization;
using Microsoft.AspNetCore.Mvc;
using System.Threading.Tasks;

namespace NewBalance.Server.Controllers.v1.Catalog
{
